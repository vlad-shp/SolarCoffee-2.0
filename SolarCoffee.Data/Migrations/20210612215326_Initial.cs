    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoriesAccounting", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InventoriesAccounting_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrders_Deliveries_DeliveryId",
                        column: x => x.DeliveryId,
                        principalTable: "Deliveries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrders_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SalesOrders_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoriesAccounting_ProductId",
                table: "InventoriesAccounting",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_DeliveryId",
                table: "SalesOrders",
                column: "DeliveryId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_DiscountId",
                table: "SalesOrders",
                column: "DiscountId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesOrders_PaymentId",
                table: "SalesOrders",
                column: "PaymentId");
        }
